import requests
from methods import chat, message
...
class EzTg:
    ...
    def sendMessage(self, chat_id, text, parse_mode='Markdown', disable_web_page_preview=False,
        ...
        return message.sendMessage(self, chat_id, text, parse_mode, disable_web_page_preview, disable_notification, reply_to_message_id, reply_markup)

    """deleteMessage method"""

    def deleteMessage(self, chat_id, message_id):
        return message.deleteMessage(self, chat_id
        , message_id)
    ...
    def editMessageText(self, chat_id, message_id, text, inline_message_id=None, parse_mode='Markdown', entities=None,
        ...
        return message.editMessageText(self, chat_id, message_id, text, inline_message_id, parse_mode, entities, disable_web_page_preview, reply_markup)

    """forwardMessage method"""

    def forwardMessage(self, chat_id, from_chat_id, message_id, disable_notification=False):
        return message.forwardMessage(self, chat_id, from_chat_id, message_id, disable_notification)
    ...
    def copyMessage(self, chat_id, message_id, caption=None, disable_notification=False, reply_to_message_id=None, allow_sending_without_reply=False, reply_markup=None):
        return message.copyMessage(self, chat_id, message_id, caption, disable_notification, reply_to_message_id, allow_sending_without_reply, reply_markup)

    """exportChatInviteLink method"""

    def exportChatInviteLink(self, chat_id):
        return chat.exportChatInviteLink(self, chat_id)
    ...
    def createChatInviteLink(self, chat_id, name=None, expire_date=None, member_limit=None, creates_join_request=False):
        return chat.createChatInviteLink(self, chat_id, name, expire_date, member_limit, creates_join_request)

    """setChatPhoto method"""

    def setChatPhoto(self, chat_id, photo):
        return chat.setChatPhoto(self, chat_id, photo)

    """pinChatMessage method"""

    def pinChatMessage(self, chat_id, message_id, disable_notification=False):
        return chat.pinChatMessage(self, chat_id, message_id, disable_notification)

    """unpinChatMessage method"""

    def unpinChatMessage(self, chat_id, message_id):
        return chat.unpinChatMessage(self, chat_id, message_id)

    """leaveChat method"""

    def leaveChat(self, chat_id):
        return chat.leaveChat(self, chat_id)
    ...
    def help(self):
        return "To see our documentation please take a look to https://purring-action-2bd.notion.site/EzTg-d39484e308d04fc6aa8eee592e4eeabe, also remember to check telegram core api documentation at https://core.telegram.org/bots/api"
